...
import { setResetFilters } from "../../redux/paginationAndFilters/paginationAndFiltersSlice";
...
const ProductsNavigation = () => {
    ...
    const currentFilters = useSelector((state) => state.paginationAndFilters.filters);
